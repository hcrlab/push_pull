...
int main(int argc, char** argv) {
  ...
  index_card.pose.pose.position.y = -0.27;
  index_card.pose.pose.position.z = 1.16;
  index_card.pose.pose.orientation.x = 1;
  index_card.pose.pose.orientation.y = 0;
  index_card.pose.pose.orientation.z = 0;
  index_card.pose.pose.orientation.w = 0;
  mock_perception.SetItems(6, {index_card});
  index_card.pose.pose.position.x = 0.56;
  index_card.pose.pose.position.y = -0.3;
  index_card.pose.pose.position.z = 1.16;
  index_card.pose.pose.orientation.x = 1;
  index_card.pose.pose.orientation.y = 0;
  index_card.pose.pose.orientation.z = 0;

...
#include <ap_msgs/ObjectList.h>
#include <adaptive_perception_msgs/ObjectDetectionRequest.h>
#include <ap_msgs/Object.h>
//#include <ap_msgs/WorldModelOperation.h>
...
private:
   ...
   ///return only yaw + xyz
    ...
    void detectCallback(const adaptive_perception_msgs::ObjectDetectionRequestConstPtr &cmd);

...
class GraspPlannerExperiment(smach.State):
    ...
    def __init__(self, **services):
        smach.State.__init__(
            ...
            output_keys=['re_sense_attempt', 'previous_item', 'bounding_box_pose', 'bounding_box', 'before_record']
        )
    ...
    def execute(self, userdata):
        ...
        # self.bag.close()
        return outcomes.GRASP_MOVE_OBJECT

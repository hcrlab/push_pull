...
class PushSidewaysExperiment(RepositionAction):
    '''
    ...
    def set_params(self, side, distance_to_push, distance_from_front_to_apply_tool=None):
        self._side = side
        self._distance_to_push = distance_to_push
        self._distance_from_front_to_apply_tool = distance_from_front_to_apply_tool
    ...
    def build_trajectory(self):
        ...
        distance_from_end = self._distance_to_push #float(raw_input("Distance to push the object: "))

        distance_x = back_end.x - self.tool_length

        if(self.action_name == 'push_point_contact'):
            distance_x =  front_end.x + self._distance_from_front_to_apply_tool \
                        - self.tool_length

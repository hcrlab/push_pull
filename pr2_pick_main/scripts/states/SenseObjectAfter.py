...
class SenseObjectAfter(smach.State):
    ...
    def __init__(self, **services):
        ...
        smach.State.__init__(
            self,
            outcomes=[outcomes.SENSE_OBJECT_AFTER_SUCCESS,
                      outcomes.SENSE_OBJECT_AFTER_FAILURE],
    ...
    @handle_service_exceptions(outcomes.SENSE_OBJECT_AFTER_FAILURE)
    def execute(self, userdata):
        ...
        if len(clusters) == 0:
            ...
            return outcomes.SENSE_OBJECT_AFTER_FAILURE
        elif len(clusters) > 1:
